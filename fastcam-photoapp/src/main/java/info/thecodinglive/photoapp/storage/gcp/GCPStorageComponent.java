...
public class GCPStorageComponent {
    ...
    public void downloadGcpStorage(String bucketName, String objectName, String destPath) {
    ...
    public void downloadGcpStorage(String objectName, HttpServletResponse response) {
